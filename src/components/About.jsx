        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-gray-600 mb-6">
              Founded in 2018, Sri Vishnu Package has grown to become a leading manufacturer of cardboard packaging solutions. We combine traditional craftsmanship with modern technology to deliver superior quality products.
            </p>
